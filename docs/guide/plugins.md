...
- [`inspect-robots-ros`](https://github.com/limike954/trajectory-data-00005/tree/main/plugins/inspect-robots-ros):
  run evals on ROS 1 or ROS 2 arms through rosbridge, with no ROS installation
  on the eval machine (`--embodiment ros`).
- [`inspect-robots-isaacsim`](https://github.com/limike954/trajectory-data-00005/tree/main/plugins/inspect-robots-isaacsim):
  run evals against an [Isaac Lab](https://isaac-sim.github.io/IsaacLab/)
  simulation (`--embodiment isaacsim`).
- [`inspect-robots-xpolicylab`](https://github.com/limike954/trajectory-data-00005/tree/main/plugins/inspect-robots-xpolicylab):
...
- [`inspect-robots-agent`](https://github.com/limike954/trajectory-data-00005/tree/main/plugins/inspect-robots-agent):
  ...
  to fine-tuned VLAs.
- [`inspect-robots-capx`](https://github.com/limike954/trajectory-data-00005/tree/main/plugins/inspect-robots-capx):
